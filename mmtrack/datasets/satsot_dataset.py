# -*- encoding: utf-8 -*-
"""
# @Time    : 2022/11/16 下午7:04
# @Author  : Jianwei Yang
# @File    : satsot_dataset.py
# @Project: mmtracking
"""
...
class SATSOTDataset(BaseSOTDataset):
    """
    SATSOT dataset of single object tracking.
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(SATSOTDataset, self).__init__(*args, **kwargs)
